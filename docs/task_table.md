...
| T-013.16 | 1.10 | OAuth スコープ不一致時の再認証ハンドリング | [implementation_plan.md](implementation_plan.md#t-01316-oauth-スコープ不一致時の再認証ハンドリング) | [#98](https://github.com/nakagawah13/fishing-forecast-gcal/issues/98) | 🔵 In Progress |
